...
const InfoBox = ({ location, onClose }) => {
  ...
  return (
    <Box
      sx={{
        width: isCollapsed ? 0 : 300, // Conditional width
        height: "100vh",
        ...
        position: "relative", // Relative positioning for the IconButton
      }}
    >
      <IconButton
        onClick={onClose}
      ...
      <IconButton
        ...
        sx={{
          position: "absolute",
          right: isCollapsed ? 5 : 250, // Conditional right position
          bottom: 100, // Move the button outside the box
          zIndex: 2, // zIndex to place it on top
